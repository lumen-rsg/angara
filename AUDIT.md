...
> `CHAPERONE.md`). In the type system: **TS-2 (soundness + bounds), TS-3, TS-4,
> TS-5, TS-6, TS-7** are fixed; TS-1 (trait objects) and the monomorphization
> half of TS-2 remain open (collections are unblocked — see LIB-3).
