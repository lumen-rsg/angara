...
namespace angara {
    ...
    std::string to_string(const TokenType &type) {
        ...
        static const char *const names[] = {
                ...
                "LESS", "LESS_EQUAL",
                "PIPE", "AMPERSAND", "CARET", "TILDE", "QUESTION_QUESTION", "DOT_DOT", "DOT_DOT_DOT", "QUESTION_DOT",
                ...
                "PRIVATE", "PUBLIC", "EXPORT", "CONTRACT", "SIGNS", "BREAK", "CONTINUE", "IS", "DATA",
                "ENUM", "MATCH", "CASE", "FOREIGN", "INTRINSIC", "SIZEOF", "RETYPE",
