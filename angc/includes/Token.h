...
namespace angara {
    ...
    enum class TokenType {
        ...
        FOR, WHILE, IN,
        FUNC, RETURN, TRUE, FALSE, TRY, CATCH, FINALLY, ATTACH, NIL, THROW, FROM,
        CLASS, THIS, INHERITS, SUPER, TRAIT, USES, STATIC, PRIVATE, PROTECTED, PUBLIC, EXPORT, CONTRACT, SIGNS,
        BREAK, CONTINUE, IS, DATA, ENUM, MATCH, CASE, FOREIGN, INTRINSIC, UNION, OWNED, DROP, TYPE,
        ASYNC, AWAIT,
