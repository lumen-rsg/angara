...
Use `foreign func` to declare a C function's signature. The compiler infers
linkage from the signature and links against libc automatically (and you can
link additional libraries via the build system).
