...
// Helper: perform a simple HTTP request with method, url, optional body and headers
...
// http.post(url, body?, headers?) -> record
...
// http.put(url, body?, headers?) -> record
...
// http.delete(url, headers?) -> record
...
// http.patch(url, body?, headers?) -> record
