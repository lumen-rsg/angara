//
// json.c — Angara JSON module (rewritten for 16-byte ABI + vtable)
//
// Uses json_bridge.h (C++ nlohmann::json wrapper) for actual parsing.
//
...
// --- Convert Angara object back to JSON handle ---
