...
AngaraObject Angara_calltest_invoke(int arg_count, AngaraObject* args) {
    ...
    if (arg_count < 3) { ang_api->throw_error("calltest.invoke: expected 3 arguments"); return ang_nil(); }
...
AngaraObject Angara_calltest_invoke0(int arg_count, AngaraObject* args) {
    if (arg_count < 1) { ang_api->throw_error("calltest.invoke0: expected 1 argument"); return ang_nil(); }
...
AngaraObject Angara_calltest_invoke1(int arg_count, AngaraObject* args) {
    if (arg_count < 2) { ang_api->throw_error("calltest.invoke1: expected 2 arguments"); return ang_nil(); }
