...
// Generic header for ALL data instances.
// This MUST match the layout generated by the transpiler.
typedef struct {
    Object obj;
    AngaraDataInfo* info; // VTable pointer
} AngaraDataInstanceHeader;

// The Metadata/VTable for a Data struct
...
// Exception handling (for transpiled try/catch blocks)
